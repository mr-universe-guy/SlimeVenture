 ...
 * @author matt
 */
public class TilingBox extends AbstractBox{
     ...
     */
    public TilingBox(float x, float y, float z) {
        super();
     ...
     */
    @Deprecated
    public TilingBox(Vector3f center, float x, float y, float z) {
        super();
     ...
     */
    public TilingBox(Vector3f min, Vector3f max) {
        super();
...
//        }
        FloatBuffer fpb = BufferUtils.createVector2Buffer(24);
        Vector3f[] v = computeVertices();
        fpb.put(new float[]{
            v[0].x, v[0].y, v[1].x, v[1].y, v[2].x, v[2].y, v[3].x, v[3].y, // back
                v[1].y, v[1].z, v[4].y, v[4].z,  v[6].y, v[6].z, v[2].y, v[2].z, // right
                v[4].x, v[4].y, v[5].x, v[5].y, v[7].x, v[7].y, v[6].x, v[6].y, // front
                v[5].y, v[5].z, v[0].y, v[0].z, v[3].y, v[3].z, v[7].y, v[7].z, // left
                v[2].x, v[2].z, v[6].x, v[6].z, v[7].x, v[7].z, v[3].x, v[3].z, // top
                v[0].x, v[0].z, v[5].x, v[5].z, v[4].x, v[4].z, v[1].x, v[1].z  // bottom
        });
        setBuffer(VertexBuffer.Type.TexCoord, 2, fpb);
    }
